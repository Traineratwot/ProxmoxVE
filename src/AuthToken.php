...
class AuthToken {
	 ...
	 * Constructor.
	 *
	 * @param string $csrf       The CSRF prevention token given by Proxmox at login time.
	 * @param string $ticket     The ticket representing a valid session given by Proxmox at login time.
